%SCS
war_A1 = readmatrix('war_A1_ego_trans.csv');
war_A2 = readmatrix('war_A2_ego_trans.csv');
war_A3 = readmatrix('war_A3_ego_trans.csv');
war_A4 = readmatrix('war_A4_ego_trans.csv');
...
% sym_data_TT0 = [A1_TT0(:,1),  A2_TT0(:,1), A3_TT0(:,1), A4_TT0(:,1)];
% sym_data_TT1 = [A1_TT1(:,1),  A2_TT1(:,1), A3_TT1(:,1), A4_TT1(:,1)];

sym_data = [A1_TT0(:,1), A1_TT1(:,1), A2_TT0(:,1), A2_TT1(:,1), A3_TT0(:,1), A3_TT1(:,1), A4_TT0(:,1), A4_TT1(:,1)]/total_num_networks;

% asym_data_TT0 = [A1_TT0_asym(:,1),  A2_TT0_asym(:,1), A3_TT0_asym(:,1), A4_TT0_asym(:,1)];
% asym_data_TT1 = [A1_TT1_asym(:,1),  A2_TT1_asym(:,1), A3_TT1_asym(:,1), A4_TT1_asym(:,1)];
...
subplot(1,3,1)
%'Labels', {{'1';'1';'2';'2';'3';'3';'4';'4'}, repmat({'TT0', 'TT1'}, 1,4)}
...
% boxplot(sym_data_TT0, 'Labels', {1,2,3,4})
% hold on
% boxplot(sym_data_TT1, 'Labels', {1,2,3,4})
% hold off
